...
## pull: ./offline-installation-tool.sh -s -l images-list.txt -d ./kubesphere-images
## push: ./offline-installation-tool.sh -l images-list.txt -d ./kubesphere-images -r dockerhub.kubekey.local
