...
| 192.168.1.209   | k8s-worker-node2  | worker                    |
 ...
 安装方式只有[离线版](#离线安装方式)，还有其他小功能，在[其他功能](#其他功能)里面可以查看。
...
```shell
mv kubeeasy-v1.3.0-alpha-3 /usr/bin/kubeeasy && chmod +x /usr/bin/kubeeasy
```
...
kubeeasy install kubernetes \
  ...
  --offline-file kubeeasy-v1.3.0-alpha-3.tar.gz
```
